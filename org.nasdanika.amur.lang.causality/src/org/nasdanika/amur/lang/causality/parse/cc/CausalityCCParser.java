...
public class CausalityCCParser extends Parser {
	...
	public CausalityCCParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class TranslationUnitContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(CausalityCCParser.EOF, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitTranslationUnit(this);
	...
	public static class TemplateContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitTemplate(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TextContext extends ParserRuleContext {
		public TerminalNode TEXT(int i) {
			return getToken(CausalityCCParser.TEXT, i);
		}
		public List<TerminalNode> TEXT() { return getTokens(CausalityCCParser.TEXT); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitText(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InterpolationContext extends ParserRuleContext {
		public TerminalNode Interpolation() { return getToken(CausalityCCParser.Interpolation, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitInterpolation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EvaluationContext extends ParserRuleContext {
		public List<TerminalNode> Evaluation() { return getTokens(CausalityCCParser.Evaluation); }
		public TerminalNode Evaluation(int i) {
			return getToken(CausalityCCParser.Evaluation, i);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitEvaluation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SectionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ParallelSectionContext extends ParserRuleContext {
		public TerminalNode ParallelSectionStart() { return getToken(CausalityCCParser.ParallelSectionStart, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		public TerminalNode SectionEnd() { return getToken(CausalityCCParser.SectionEnd, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitParallelSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SequentialSectionContext extends ParserRuleContext {
		public TerminalNode SequentialSectionStart() { return getToken(CausalityCCParser.SequentialSectionStart, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		public TerminalNode SectionEnd() { return getToken(CausalityCCParser.SectionEnd, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitSequentialSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SynchronousSectionContext extends ParserRuleContext {
		public TerminalNode SynchronousSectionStart() { return getToken(CausalityCCParser.SynchronousSectionStart, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		public TerminalNode SectionEnd() { return getToken(CausalityCCParser.SectionEnd, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitSynchronousSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ConditionalContext extends ParserRuleContext {
		...
		public TerminalNode ConditionalEnd() { return getToken(CausalityCCParser.ConditionalEnd, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitConditional(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ConditionalMainPartContext extends ParserRuleContext {
		...
		public TerminalNode ConditionalStart() { return getToken(CausalityCCParser.ConditionalStart, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitConditionalMainPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ConditionalElseIfPartContext extends ParserRuleContext {
		...
		public TerminalNode ElseIf() { return getToken(CausalityCCParser.ElseIf, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitConditionalElseIfPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ConditionalElsePartContext extends ParserRuleContext {
		public TerminalNode Else() { return getToken(CausalityCCParser.Else, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitConditionalElsePart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IterationContext extends ParserRuleContext {
		public TerminalNode IterationStart() { return getToken(CausalityCCParser.IterationStart, 0); }
		public TerminalNode IterationEnd() { return getToken(CausalityCCParser.IterationEnd, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitIteration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class WhenContext extends ParserRuleContext {
		public TerminalNode WhenStart() { return getToken(CausalityCCParser.WhenStart, 0); }
		public TerminalNode WhenEnd() { return getToken(CausalityCCParser.WhenEnd, 0); }
		public TemplateContext template() {
			return getRuleContext(TemplateContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CausalityCCVisitor ) return ((CausalityCCVisitor<? extends T>)visitor).visitWhen(this);
			else return visitor.visitChildren(this);
		}
	}
