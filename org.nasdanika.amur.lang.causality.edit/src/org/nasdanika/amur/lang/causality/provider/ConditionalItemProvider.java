...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.lang.causality.Conditional} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CausalityPackage.Literals.CONDITIONAL__PARTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Conditional.class)) {
			case CausalityPackage.CONDITIONAL__PARTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CausalityPackage.Literals.CONDITIONAL__PARTS,
				 CausalityFactory.eINSTANCE.createConditionalPart()));
	}
