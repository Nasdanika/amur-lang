...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.lang.causality.Evaluation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvaluationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Evaluation_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Evaluation_code_feature", "_UI_Evaluation_type"),
				 CausalityPackage.Literals.EVALUATION__CODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Evaluation)object).getCode();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Evaluation.class)) {
			case CausalityPackage.EVALUATION__CODE:
