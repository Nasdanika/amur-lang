...
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPBaseVisitor;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.ConditionalContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.ConditionalElseIfPartContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.ConditionalElsePartContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.ConditionalMainPartContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.EvaluationContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.InterpolationContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.IterationContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.ParallelSectionContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.SequentialSectionContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.SynchronousSectionContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.TemplateContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.TextContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.TranslationUnitContext;
import org.nasdanika.amur.lang.causality.parse.cp.CausalityCPParser.WhenContext;

public class TranslationUnitBuilderCP extends CausalityCPBaseVisitor<EObject> {
	private Mode mode;
	private DiagnosticChain diagnostic;
	private AtomicBoolean validationResult;
	private Object source;

	public TranslationUnitBuilderCP(
			Mode initialMode,
